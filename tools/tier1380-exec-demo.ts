...
console.log("   bun run tier1380-exec.ts -p @angular/cli@15.0.0 ng new my-app --routing");
console.log("   → Package: Mapped | Version: Specified | CLI: Angular");

console.log("\n5. 🔍 Quick Integrity Check (Dry Run):");
console.log(`   bun -e 'const pkg=\"prisma\";console.log(\`Audit: \${Bun.hash.wyhash(Buffer.from(pkg)).toString(16)}\')'`);
