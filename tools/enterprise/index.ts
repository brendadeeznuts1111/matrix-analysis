 ...
 */
export function createArchiveManager(tenantId: string = 'default'): EnterpriseArchiveManager {
...
export class MigrationHelper {
  ...
  static migrateFromArchiveTools() {
    ...
    console.log('  bun tools/enterprise/cli/EnterpriseArchiveCLI.ts create ./src --tenant production');
    console.log('');
  ...
  static migrateFromTier1380ArchiveSecure() {
    console.log('🔄 Migration Guide: tier1380-archive-secure.ts → EnterpriseArchiveManager');
    console.log('');
...
export class ArchiveIntegrityError extends EnterpriseArchiveError {
  constructor(message: string, public readonly checksum: string) {
