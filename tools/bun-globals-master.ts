  ...
  Debug: [
    {
      ...
      signature: 'Bun.openInEditor(path: string, opts?: {editor?: string, line?: number})',
    ...
    },
    {
      ...
      signature: 'Bun.inspect.table(data: any[], props?: string[], opts?: {colors: bool})',
  ...
  Streams: [
    {
      ...
      signature: 'readableStreamToArrayBuffer/Bytes/Blob/JSON/Text/Array/FormData(stream)',
