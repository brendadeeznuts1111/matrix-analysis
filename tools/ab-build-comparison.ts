...
async function generateReport() {
  ...
  for (const build of builds) {
    ...
    console.log(`  Has Defines: ${build.features.hasDefines ? "✓ (not inlined)" : "✗ (inlined!)"}`);
  ...
  if (builds.length === 2) {
    ...
    console.log(`  Status:    ${diff === 0 ? "Identical ✓" : `A is ${diff > 0 ? "larger" : "smaller"}`}`);
    console.log("═══════════════════════════════════════════════════════════════════\n");
  }
