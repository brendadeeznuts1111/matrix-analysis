...
async function testBunBuildTypes() {
  ...
  console.log('✅ Build config with autoloadPackageJson:', buildConfig.autoloadPackageJson);
...
async function runTypeTests(): Promise<void> {
  ...
  try {
    ...
    await Bun.write('./typescript-type-fixes-results.json', JSON.stringify(report, null, 2));
