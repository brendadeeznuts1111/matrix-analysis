...
// Define base paths
const BASE_DIR = "/Users/nolarose/mcp-tools";
...
const AUDIT_DIR = `${BASE_DIR}/audit-review`;
...
`;
  ...
  writeFileSync(`${BASE_DIR}/setup-paths.sh`, shellScript);
  console.log(`✅ Created shell script: ${BASE_DIR}/setup-paths.sh`);
}
...
`;
  ...
  writeFileSync(`${BASE_DIR}/paths.ts`, tsContent);
  console.log(`✅ Created TypeScript paths file: ${BASE_DIR}/paths.ts`);
}
...
`;
  ...
  writeFileSync(`${BASE_DIR}/.env.template`, envTemplate);
  console.log(`✅ Created .env template: ${BASE_DIR}/.env.template`);
}
