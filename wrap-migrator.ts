 ...
 */
function detectTargetImport(node: Node, targetModule: string): node is ImportDeclaration {
...
`);
  ...
  console.log(`   Files/Second:      ${(stats.filesScanned / (duration / 1000)).toFixed(1)}`);
