...
if (import.meta.main) {
	...
	const format = (args.find((a) => a.startsWith("--format="))?.split("=")[1] || "text") as ReportOptions["format"];
	const output = args.find((a) => a.startsWith("--output="))?.split("=")[1];
	const severity = (args.find((a) => a.startsWith("--severity="))?.split("=")[1] || "all") as ReportOptions["severity"];
