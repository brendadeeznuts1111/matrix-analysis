...
async function runBenchmark(name: string, fn: () => Promise<void>, iterations = 100): Promise<BenchmarkResult> {
...
async function benchmarkCol89Check(): Promise<BenchmarkResult> {
	...
	return runBenchmark("Col-89 Check", () => {
...
async function benchmarkHashCalculation(): Promise<BenchmarkResult> {
	...
	return runBenchmark("Hash (wyhash)", () => {
...
async function benchmarkMessageValidation(): Promise<BenchmarkResult> {
	...
	return runBenchmark("Message Validation", () => {
...
async function benchmarkTableRender(): Promise<BenchmarkResult> {
	...
	return runBenchmark("Table Render", () => {
...
if (import.meta.main) {
	...
	console.log("Results:");
	console.log();
	console.log(Bun.inspect.table(results, ["name", "iterations", "totalTime", "avgTime", "throughput"]));
