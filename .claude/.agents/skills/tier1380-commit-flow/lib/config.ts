...
export async function printConfig(config: CommitFlowConfig): Promise<void> {
	...
	const sections = [
		{ title: "Pre-commit Checks", keys: ["autoFix", "enableLint", "enableTypeCheck", "enableTests", "enableSecretsScan", "enableCol89"] },
		{ title: "Commit Settings", keys: ["autoStage", "signCommits"] },
		{ title: "Branch Protection", keys: ["protectedBranches", "requirePRForProtected"] },
		{ title: "Defaults", keys: ["defaultDomain", "defaultComponent", "defaultTier"] },
		{ title: "Dashboard", keys: ["dashboardRefreshInterval", "enableDashboardTrends"] },
	];
